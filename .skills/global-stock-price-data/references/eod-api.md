...
**Endpoint:** `GET https://app-cr7tniae4g01-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod`
...
async function getEodData(symbol: string, params: EodParams = {}): Promise<EodResponse> {
  ...
  const response = await fetch(
    `https://app-cr7tniae4g01-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod?${query.toString()}`,
