...
**Endpoint:** `GET https://app-cr7tniae4g01-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}`
...
async function getNewsByUuid(uuid: string): Promise<NewsArticle> {
  const response = await fetch(
    `https://app-cr7tniae4g01-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/${encodeURIComponent(uuid)}`,
    {
      method: "GET",
      headers: {
