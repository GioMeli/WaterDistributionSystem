...
**Endpoint:** `GET https://app-cr7tniae4g01-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all`
...
async function getAllNews(params: AllNewsParams = {}): Promise<AllNewsResponse> {
  ...
  const response = await fetch(
    `https://app-cr7tniae4g01-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
